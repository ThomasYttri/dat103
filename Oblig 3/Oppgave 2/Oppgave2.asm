...
_start:
	...
	call lestall
	mov eax,ecx	; Første tall lagres i reg eax

	call lestall
	mov ebx,ecx	; Andre tall lagres i reg ebx
...
; ---------------------------------------------------------
lestall:
	; Les tall, innlest tall retuneres i ecx
	; Vellykket retur dersom edx=0

	; Leser første siffer og ganger det med 10
	push eax
	call lessiffer
	...
	; Summer siffer for å få innlest tall
	add eax, ecx
	mov ecx, eax
	pop eax
	ret
